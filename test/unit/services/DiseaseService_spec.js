...
describe('Unit:: Service: DiseaseService', function() {
  ...
  beforeEach(function() {
    ...
    angular.mock.inject(($httpBackend, DiseaseService, _$timeout_, DiseaseModel, _$resource_, _AppSettings_, $localStorage) => {
  ...
  it('should retrieve disease results', ()=>{
    ...
    http.expect('GET', '/diseases/').respond(200, { count: 1, results:  [{'acronym': 'PRAD', 'name': 'prostate adenocarcinoma'}] });
