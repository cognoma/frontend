describe("UNIT: on_config", function() {
    ...
    it("$urlRouterProvider: should have called registered 9 routes", function() {
        //Otherwise internally calls when. So, call count of when has to be 9
        expect($_urlRouterProvider.when.calls.count()).toBe(9);
    });
